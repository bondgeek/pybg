/* Generated by Cython 0.16 on Mon Jul  9 13:19:03 2012 */
...
/* "pybg/instruments/fixedfloatswap.pxd":12
...
/* "pybg/instruments/fixedfloatswap.pxd":20
...
/* "pybg/instruments/fixedfloatswap.pxd":26
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely(values[1])) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("__init__", 0, 5, 13, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 254; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__maturity);
        if (likely(values[2])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__init__", 0, 5, 13, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 254; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__fixedRate);
        if (likely(values[3])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__init__", 0, 5, 13, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 254; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__payerType);
        if (likely(values[4])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__init__", 0, 5, 13, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 254; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s__floating_spread);
      ...
      if (values[5]) {
        ...
        /* "pybg/instruments/fixedfloatswap.pyx":260
 *             Rate fixedRate,
 *             SwapPayType payerType,
 *             Spread floating_spread=0.0,             # <<<<<<<<<<<<<<
 *             Real notional=1000000.0,
 ...
 */
    ...
    __pyx_v_settle = values[1];
    __pyx_v_maturity = values[2];
    __pyx_v_fixedRate = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_fixedRate == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 258; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_payerType = ((enum SwapPayType)PyInt_AsLong(values[4])); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 259; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[5]) {
      __pyx_v_floating_spread = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_floating_spread == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 260; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
 ...
 */
    ...
    if (values[6]) {
      __pyx_v_notional = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_notional == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 261; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
 ...
 */
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__init__", 0, 5, 13, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 254; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("pybg.instruments.fixedfloatswap.EuriborSwap.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_fixedLegDayCounter), __pyx_ptype_4pybg_8quantlib_4time_10daycounter_DayCounter, 1, "fixedLegDayCounter", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 264; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_floatingLegDayCounter), __pyx_ptype_4pybg_8quantlib_4time_10daycounter_DayCounter, 1, "floatingLegDayCounter", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 268; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* "pybg/instruments/fixedfloatswap.pyx":254
 * 
 * cdef class EuriborSwap(LiborSwap):
 *     def __init__(self,             # <<<<<<<<<<<<<<
 *             tenor,
...
static int __pyx_pf_4pybg_11instruments_14fixedfloatswap_11EuriborSwap___init__(struct __pyx_obj_4pybg_11instruments_14fixedfloatswap_EuriborSwap *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v_tenor, PyObject *__pyx_v_settle, PyObject *__pyx_v_maturity, __pyx_t_4pybg_11instruments_14fixedfloatswap_Rate __pyx_v_fixedRate, enum SwapPayType __pyx_v_payerType, __pyx_t_4pybg_11instruments_14fixedfloatswap_Spread __pyx_v_floating_spread, __pyx_t_4pybg_11instruments_14fixedfloatswap_Real __pyx_v_notional, PyObject *__pyx_v_fixedLegFrequency, struct __pyx_obj_4pybg_8quantlib_4time_10daycounter_DayCounter *__pyx_v_fixedLegDayCounter, PyObject *__pyx_v_fixedLegConvention, PyObject *__pyx_v_floatingLegFrequency, struct __pyx_obj_4pybg_8quantlib_4time_10daycounter_DayCounter *__pyx_v_floatingLegDayCounter, PyObject *__pyx_v_floatingLegConvention) {
  ...
  /* "pybg/instruments/fixedfloatswap.pyx":274
 *         self._swaptype = \
 ...
 *                 <_BusinessDayConvention>fixedLegConvention,
 */
  __pyx_t_1 = ((enum QuantLib::Frequency)PyInt_AsLong(__pyx_v_fixedLegFrequency)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 274; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pybg/instruments/fixedfloatswap.pyx":276
 *                 <_Frequency>fixedLegFrequency,
 *                 deref(fixedLegDayCounter._thisptr),
 *                 <_BusinessDayConvention>fixedLegConvention,             # <<<<<<<<<<<<<<
 *                 <_Frequency>floatingLegFrequency,
 *                 deref(floatingLegDayCounter._thisptr),
 */
  __pyx_t_2 = ((enum QuantLib::BusinessDayConvention)PyInt_AsLong(__pyx_v_fixedLegConvention)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 276; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *                 <_BusinessDayConvention>floatingLegConvention,
 */
  __pyx_t_3 = ((enum QuantLib::Frequency)PyInt_AsLong(__pyx_v_floatingLegFrequency)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 277; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "pybg/instruments/fixedfloatswap.pyx":279
 *                 <_Frequency>floatingLegFrequency,
 *                 deref(floatingLegDayCounter._thisptr),
 *                 <_BusinessDayConvention>floatingLegConvention,             # <<<<<<<<<<<<<<
 *                 _Calendar.TARGET()
 *                 )
 */
  __pyx_t_4 = ((enum QuantLib::BusinessDayConvention)PyInt_AsLong(__pyx_v_floatingLegConvention)); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 279; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  try {__pyx_t_5 = new bondgeek::SwapType<QuantLib::Euribor>(((enum QuantLib::Frequency)__pyx_t_1), (*__pyx_v_fixedLegDayCounter->_thisptr), ((enum QuantLib::BusinessDayConvention)__pyx_t_2), ((enum QuantLib::Frequency)__pyx_t_3), (*__pyx_v_floatingLegDayCounter->_thisptr), ((enum QuantLib::BusinessDayConvention)__pyx_t_4), QuantLib::TARGET());} catch(...) {__Pyx_CppExn2PyErr(); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 273; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}

  /* "pybg/instruments/fixedfloatswap.pyx":272
 *             ):
 * 
 *         self._swaptype = \             # <<<<<<<<<<<<<<
 *             new _fixedfloatswap.SwapType[ _euribor.Euribor ](
 ...
 */
  ...
  /* "pybg/instruments/fixedfloatswap.pyx":283
 *                 )
 * 
 *         self._thisptr = new shared_ptr[_fixedfloatswap.FixedFloatSwap]( \             # <<<<<<<<<<<<<<
 *             deref(self._swaptype).create(
...
static PyObject *__pyx_pw_4pybg_11instruments_14fixedfloatswap_11EuriborSwap_3setEngine(PyObject *__pyx_v_self, PyObject *__pyx_v_crv) {
  ...
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("setEngine (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_crv), __pyx_ptype_4pybg_6curves_RateHelperCurve, 1, "crv", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 294; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* "pybg/instruments/fixedfloatswap.pyx":294
 *             )
 * 
 *     def setEngine(self, curves.RateHelperCurve crv):             # <<<<<<<<<<<<<<
 *         cdef _curves.RateHelperCurve _crv
...
static PyObject *__pyx_pf_4pybg_11instruments_14fixedfloatswap_11EuriborSwap_2setEngine(struct __pyx_obj_4pybg_11instruments_14fixedfloatswap_EuriborSwap *__pyx_v_self, struct __pyx_obj_4pybg_6curves_RateHelperCurve *__pyx_v_crv) {
  ...
  /* "pybg/instruments/fixedfloatswap.pyx":297
 *         cdef _curves.RateHelperCurve _crv
 * 
 *         _crv = deref(crv._thisptr.get())             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pybg/instruments/fixedfloatswap.pyx":299
 *         _crv = deref(crv._thisptr.get())
 * 
 *         deref(self._swaptype).linkIndex(_crv)             # <<<<<<<<<<<<<<
 *         self._thisptr.get().setEngine(_crv)
...
#endif
{
  ...
  if (PyType_Ready(&__pyx_type_4pybg_11instruments_14fixedfloatswap_EuriborSwap) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 253; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "EuriborSwap", (PyObject *)&__pyx_type_4pybg_11instruments_14fixedfloatswap_EuriborSwap) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 253; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  /* "pybg/instruments/fixedfloatswap.pyx":263
 *             Real notional=1000000.0,
 *             # Fixed Leg
 *             fixedLegFrequency=Annual,             # <<<<<<<<<<<<<<
 *             DayCounter fixedLegDayCounter=Thirty360(EUROPEAN),
 ...
 */
  __pyx_t_5 = __Pyx_GetName(__pyx_m, __pyx_n_s__Annual); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 263; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 *             # floating leg
 */
  __pyx_t_5 = __Pyx_GetName(__pyx_m, __pyx_n_s__Thirty360); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 264; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __Pyx_GetName(__pyx_m, __pyx_n_s__EUROPEAN); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 264; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;
  if (!(likely(((__pyx_t_3) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_3, __pyx_ptype_4pybg_8quantlib_4time_10daycounter_DayCounter))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 264; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_3 = __Pyx_GetName(__pyx_m, __pyx_n_s__Unadjusted); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 265; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_k_13 = __pyx_t_3;
  __Pyx_GIVEREF(__pyx_t_3);
  __pyx_t_3 = 0;

  /* "pybg/instruments/fixedfloatswap.pyx":267
 *             fixedLegConvention=Unadjusted,
 *             # floating leg
 *             floatingLegFrequency=Semiannual,             # <<<<<<<<<<<<<<
 *             DayCounter floatingLegDayCounter=Actual360(),
 *             floatingLegConvention=ModifiedFollowing
 */
  __pyx_t_3 = __Pyx_GetName(__pyx_m, __pyx_n_s__Semiannual); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 267; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
 ...
 *             ):
 */
  __pyx_t_3 = __Pyx_GetName(__pyx_m, __pyx_n_s__Actual360); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 268; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (!(likely(((__pyx_t_4) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_4, __pyx_ptype_4pybg_8quantlib_4time_10daycounter_DayCounter))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 268; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_k_15 = ((struct __pyx_obj_4pybg_8quantlib_4time_10daycounter_DayCounter *)__pyx_t_4);
  __Pyx_GIVEREF(__pyx_t_4);
  __pyx_t_4 = 0;

  /* "pybg/instruments/fixedfloatswap.pyx":270
 *             DayCounter floatingLegDayCounter=Actual360(),
 *             floatingLegConvention=ModifiedFollowing
 *             ):             # <<<<<<<<<<<<<<
 * 
 *         self._swaptype = \
 */
  __pyx_t_4 = __Pyx_GetName(__pyx_m, __pyx_n_s__ModifiedFollowing); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 270; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
